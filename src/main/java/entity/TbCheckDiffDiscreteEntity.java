...
@Entity
@Table(name = "tb_check_diff_discrete", schema = "report", catalog = "")
public class TbCheckDiffDiscreteEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        TbCheckDiffDiscreteEntity that = (TbCheckDiffDiscreteEntity) o;
