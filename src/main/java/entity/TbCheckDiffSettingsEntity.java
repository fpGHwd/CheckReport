...
@Entity
@Table(name = "tb_check_diff_settings", schema = "report", catalog = "")
public class TbCheckDiffSettingsEntity {
    private int id;
    ...
    @Basic
    @Column(name = "RefVal", nullable = true, length = 64)
    ...
    @Basic
    @Column(name = "RealVal", nullable = true, length = 64)
    ...
    @Basic
    @Column(name = "ZoneNo", nullable = true)
    ...
    public boolean equals(Object o) {
        ...
        TbCheckDiffSettingsEntity that = (TbCheckDiffSettingsEntity) o;
        ...
        if (refVal != null ? !refVal.equals(that.refVal) : that.refVal != null) return false;
        if (realVal != null ? !realVal.equals(that.realVal) : that.realVal != null) return false;
        if (zoneNo != null ? !zoneNo.equals(that.zoneNo) : that.zoneNo != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (zoneNo != null ? zoneNo.hashCode() : 0);
