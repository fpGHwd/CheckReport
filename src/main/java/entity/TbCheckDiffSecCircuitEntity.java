...
@Entity
@Table(name = "tb_check_diff_sec_circuit", schema = "report", catalog = "")
public class TbCheckDiffSecCircuitEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        TbCheckDiffSecCircuitEntity that = (TbCheckDiffSecCircuitEntity) o;
