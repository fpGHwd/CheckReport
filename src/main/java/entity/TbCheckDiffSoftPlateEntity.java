...
@Entity
@Table(name = "tb_check_diff_soft_plate", schema = "report", catalog = "")
public class TbCheckDiffSoftPlateEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        TbCheckDiffSoftPlateEntity that = (TbCheckDiffSoftPlateEntity) o;
