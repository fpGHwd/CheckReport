...
@Entity
@Table(name = "tb_check_diff_soft_version", schema = "report", catalog = "")
public class TbCheckDiffSoftVersionEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        TbCheckDiffSoftVersionEntity that = (TbCheckDiffSoftVersionEntity) o;
