...
@Entity
@Table(name = "tb_check_diff_comm_status", schema = "report", catalog = "")
public class TbCheckDiffCommStatusEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        TbCheckDiffCommStatusEntity that = (TbCheckDiffCommStatusEntity) o;
