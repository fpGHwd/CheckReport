...
@Entity
@Table(name = "tb_check_diff_gps_alarm", schema = "report", catalog = "")
public class TbCheckDiffGpsAlarmEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        TbCheckDiffGpsAlarmEntity that = (TbCheckDiffGpsAlarmEntity) o;
