...
@Entity
@Table(name = "tb_check_diff_hard_plate", schema = "report", catalog = "")
public class TbCheckDiffHardPlateEntity {
    private int id;
    private String deviceId;
    private String pointId;
    private String pointName;
    private String valType;
    private Integer refVal;
    ...
    public Integer getRefVal() {
        return refVal;
    }

    public void setRefVal(Integer refVal) {
        this.refVal = refVal;
    }
    ...
    public boolean equals(Object o) {
        ...
        TbCheckDiffHardPlateEntity that = (TbCheckDiffHardPlateEntity) o;
