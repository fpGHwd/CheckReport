...
@Entity
@Table(name = "tb_check_diff_zone", schema = "report", catalog = "")
public class TbCheckDiffZoneEntity {
    private int id;
    private String deviceId;
    private String pointName;
    private String valType;
    private Integer refType; // refVal
    ...
    public boolean equals(Object o) {
        ...
        TbCheckDiffZoneEntity that = (TbCheckDiffZoneEntity) o;
